...
enum ability_type
{
    ...
    // Housing ability ids are fixed for save compatibility.
    ABIL_HOUSING_ACQUIRE = 9000,
    ABIL_FIRST_HOUSING = ABIL_HOUSING_ACQUIRE,
    ...
    ABIL_HOUSING_MANAGE_MAPS = 9006,
    ABIL_HOUSING_CREATE_MONSTER = 9007,
    ABIL_HOUSING_CALL_MERCHANT,
    ABIL_HOUSING_TRAVEL_TO_MAP = 9009,
    ABIL_HOUSING_TOGGLE_VISITOR_WALL = 9010,
    ABIL_HOUSING_MANAGE_SPAWNS = 9011,
    ABIL_HOUSING_CREATE_VISITOR_STRIP = 9012,
    ABIL_HOUSING_SHOW_COORDINATES = 9013,
    ABIL_HOUSING_REMOVE_MONSTER = 9014,
    ABIL_LAST_HOUSING = ABIL_HOUSING_REMOVE_MONSTER,
    ...
    ABIL_LAST_WIZ = ABIL_WIZ_CLEAR_TERRAIN,
#endif
    NUM_ABILITIES
};
